...
img=((input_images[0]).transpose(0,1,2))
print("This is input image",img.shape)
plt.imshow(img[:,:,0])
# plt.show()
print("Expected output")
masks=np.array(target_masks.reshape(3,6,192,192))
mask=(masks[0]).transpose(1,2,0)
...
test_dataset = SimDataset(25, transform = trans)
